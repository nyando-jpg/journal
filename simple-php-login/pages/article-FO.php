...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .article-meta { color: #374151; margin-bottom: 30px; padding-bottom: 20px; border-bottom: 1px solid #eee; }
        ...
        .related-date { margin: 0 0 6px 0; font-size: 0.85rem; color: #4b5563; }
        .related-name { margin: 0; font-size: 0.95rem; color: #111827; }
        .back-link { display: inline-block; margin-top: 30px; padding: 12px 25px; background-color: #dc2626; color: white; text-decoration: none; border-radius: 5px; min-height: 44px; font-weight: 600; }
        ...
        .footer-text { margin: 0 0 8px 0; color: #e2e8f0; font-size: 0.95rem; line-height: 1.7; }
        ...
        .footer-bottom { max-width: 1200px; margin: 18px auto 0; padding: 16px 20px; border-top: 1px solid rgba(148, 163, 184, 0.35); color: #cbd5e1; font-size: 0.9rem; display: flex; justify-content: space-between; flex-wrap: wrap; gap: 10px; }
